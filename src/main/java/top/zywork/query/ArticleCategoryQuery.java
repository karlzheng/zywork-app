...
public class ArticleCategoryQuery extends PageQuery {
    ...
    private static final long serialVersionUID = -9223372035021583528L;
    ...
    public ArticleCategoryQuery () {}

    public ArticleCategoryQuery (Long id, Long idMin, Long idMax, Long parentId, Long parentIdMin, Long parentIdMax, String title, String description, Integer version, Integer versionMin, Integer versionMax, Date createTime, Date createTimeMin, Date createTimeMax, Date updateTime, Date updateTimeMin, Date updateTimeMax, Byte isActive, Byte isActiveMin, Byte isActiveMax) {
        this.id = id;
		this.idMin = idMin;
		this.idMax = idMax;
