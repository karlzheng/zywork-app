...
public class GoodsOrderVO extends BaseVO {
    ...
    private static final long serialVersionUID = -9223372035280279068L;
    ...
    public GoodsOrderVO (Long id, Long userId, String orderNo, Long totalAmount, Long payAmount, Long discountAmount, Long integralAmount, Long expressFee, Byte orderStatus, Date payTime, Byte payType, String transactionNo, Byte paySuccess, Date deliverTime, Date dealTime, Integer version, Date createTime, Date updateTime, Byte isActive) {
        this.id = id;
		this.userId = userId;
