...
/**
 * GoodsCategoryAttributeDTO数据传输对象类<br/>
 *
 * 创建于2019-02-28<br/>
 *
 ...
 * @version 1.0
 */
public class GoodsCategoryAttributeDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372036204654773L;
    ...
    public String toString() {
        return "GoodsCategoryAttributeDTO {" +
