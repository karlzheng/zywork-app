 ...
 * @version 1.0
 */
public class ModulePermissionDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372035792276836L;
    ...
    public ModulePermissionDTO (String moduleTitle, String moduleDescription, Long permissionId, Long permissionModuleId, String permissionTitle, String permissionPermission, String permissionDescription, Integer permissionVersion, Date permissionCreateTime, Date permissionUpdateTime, Byte permissionIsActive) {
