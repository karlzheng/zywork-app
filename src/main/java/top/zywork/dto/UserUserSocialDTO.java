 ...
 * @version 1.0
 */
public class UserUserSocialDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372035669194673L;
    ...
    public UserUserSocialDTO () {}

    public UserUserSocialDTO (Long userId, String userPhone, String userEmail, String userSocialOpenid, String userSocialUnionId, String userSocialRefreshToken, String userSocialSocialType, Date userSocialCreateTime) {
        this.userId = userId;
