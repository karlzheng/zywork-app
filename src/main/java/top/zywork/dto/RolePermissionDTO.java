...
public class RolePermissionDTO extends BaseDTO {
    ...
    private static final long serialVersionUID = -9223372036742452502L;
    ...
    public RolePermissionDTO (Long roleId, String roleTitle, Long permissionId, String permissionTitle, String permissionPermission) {
        this.roleId = roleId;
