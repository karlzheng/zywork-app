...
/**
 * UserGoodsOrderLogisticsDO数据对象实体类<br/>
 *
 * 创建于2019-03-12<br/>
 *
 ...
 * @version 1.0
 */
public class UserGoodsOrderLogisticsDO extends BaseDO {

    private static final long serialVersionUID = -9223372036301521171L;
    ...
    public String toString() {
        return "UserGoodsOrderLogisticsDO {" +
                "userId = " + userId + 
				", userPhone = " + userPhone + 
				", userEmail = " + userEmail + 
