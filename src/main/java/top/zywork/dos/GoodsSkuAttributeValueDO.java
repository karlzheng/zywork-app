...
/**
 * GoodsSkuAttributeValueDO数据对象实体类<br/>
 *
 * 创建于2019-02-28<br/>
 *
 ...
 * @version 1.0
 */
public class GoodsSkuAttributeValueDO extends BaseDO {

    private static final long serialVersionUID = -9223372034755665580L;
    ...
    public GoodsSkuAttributeValueDO () {}

    public GoodsSkuAttributeValueDO (Long goodsInfoId, Long goodsInfoShopId, Long goodsInfoCategoryId, Byte goodsInfoShelfStatus, Long goodsSkuId, Byte goodsSkuShelfStatus, Long goodsCategoryAttributeAttrId, Integer goodsCategoryAttributeAttrOrder, String goodsAttributeAttrName, String goodsAttributeAttrCode, String goodsAttributeAttrType, Integer goodsAttributeAttrLength, Byte goodsAttributeAttrRequired, Byte goodsAttributeAttrDisplay, String goodsAttributeValueAttrValue) {
    ...
    public String toString() {
        return "GoodsSkuAttributeValueDO {" +
