...
public class UserOrganizationDO extends BaseDO {
    ...
    private static final long serialVersionUID = -9223372036486773704L;
    ...
    public UserOrganizationDO (Long userId, String userPhone, String userEmail, Long organizationId, String organizationTitle, String organizationDescription, Date userOrganizationCreateTime, Date userOrganizationUpdateTime) {
        this.userId = userId;
