...
public class UserRoleDO extends BaseDO {
    ...
    private static final long serialVersionUID = -9223372035831026059L;
    ...
    public UserRoleDO (Long userId, String userPhone, String userEmail, Long roleId, String roleTitle, String roleDescription, Date userRoleCreateTime) {
        this.userId = userId;
