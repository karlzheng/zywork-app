 ...
 * @version 1.0
 */
public class FundsFrezeeDO extends BaseDO {

    private static final long serialVersionUID = -9223372036178040051L;
    ...
    public FundsFrezeeDO () {}

    public FundsFrezeeDO (Long id, String transactionNo, Long userId, Long amount, String frezeeType, String frezeeDescription, Integer version, Date createTime, Date updateTime, Byte isActive) {
        this.id = id;
