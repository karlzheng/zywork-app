 ...
 * @version 1.0
 */
public class DistributionUserHierarchyDO {
    ...
    public DistributionUserHierarchyDO() {}

    public DistributionUserHierarchyDO(Long id, Long ancestorId, String ancestorPhone, String ancestorNickname, String ancestorHeadicon, String usersId, String usersPhone, String usersNickname, String usersHeadicon, Integer level, Date createTime) {
        this.id = id;
