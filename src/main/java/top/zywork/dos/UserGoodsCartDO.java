 ...
 * @version 1.0
 */
public class UserGoodsCartDO extends BaseDO {

    private static final long serialVersionUID = -9223372035328877465L;
    ...
    public UserGoodsCartDO () {}

    public UserGoodsCartDO (String userDetailNickname, String userDetailHeadicon, Long userId, String userPhone, String userEmail, Long goodsSkuId, Long goodsSkuGoodsId, String goodsPicPicUrl, Integer goodsCartQuantity, Date goodsCartCreateTime, Date goodsCartUpdateTime) {
