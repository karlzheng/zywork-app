 ...
 * @version 1.0
 */
public class FundsWithdrawDO extends BaseDO {

    private static final long serialVersionUID = -9223372036297329695L;
    ...
    public FundsWithdrawDO () {}

    public FundsWithdrawDO (Long id, Long userId, String transactionNo, Long amount, Long bankcardId, Byte withdrawStatus, String withdrawDescription, Long checkedUserId, Date checkedTime, Date completeTime, Integer version, Date createTime, Date updateTime, Byte isActive) {
        this.id = id;
		this.userId = userId;
