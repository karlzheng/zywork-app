...
<FormItem label="是否默认角色" prop="isDefault">
	<InputNumber v-model="form.isDefault" placeholder="请输入是否默认角色" style="width: 100%;"/>
</FormItem>
...
<FormItem label="是否默认角色" prop="isDefault">
	...
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始角色编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束角色编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否默认角色"><Row>
	<i-col span="11">
	<FormItem prop="isDefaultMin">
	<InputNumber v-model="searchForm.isDefaultMin" placeholder="请输入开始是否默认角色" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="isDefaultMax">
	<InputNumber v-model="searchForm.isDefaultMax" placeholder="请输入结束是否默认角色" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>角色编号: <span v-text="form.id"></span></p>
<p>角色标题: <span v-text="form.title"></span></p>
<p>角色描述: <span v-text="form.description"></span></p>
<p>是否默认角色: <span v-text="form.isDefault"></span></p>
...
sortable: true
    ...
    methods: {
      ...
      fitTable() {
        utils.fitTable(this, 'dataTable', this.table.tableColumns, ['id','title','description','isDefault','version','createTime','updateTime','isActive',])
      }
    }
  }
</script>
