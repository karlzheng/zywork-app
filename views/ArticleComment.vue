...
<FormItem label="评论详情" prop="content">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="评论编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始评论编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束评论编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
<FormItem label="文章编号"><Row>
	<i-col span="11">
	<FormItem prop="articleIdMin">
	<InputNumber v-model="searchForm.articleIdMin" placeholder="请输入开始文章编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="articleIdMax">
	<InputNumber v-model="searchForm.articleIdMax" placeholder="请输入结束文章编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="评论标题" prop="title">
	<Input v-model="searchForm.title" placeholder="请输入评论标题"/>
</FormItem>
<FormItem label="评论详情" prop="content">
	<Input v-model="searchForm.content" placeholder="请输入评论详情"/>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>评论编号: <span v-text="form.id"></span></p>
<p>文章编号: <span v-text="form.articleId"></span></p>
<p>用户编号: <span v-text="form.userId"></span></p>
<p>评论标题: <span v-text="form.title"></span></p>
<p>评论详情: <span v-text="form.content"></span></p>
    ...
    data() {
      return {
        ...
        urls: {
          ...
          searchUrl: '/article-comment/admin/pager-cond',
          allUrl: '/article-comment/admin/all',
          removeUrl: '/article-comment/admin/remove/',
          batchRemoveUrl: '/article-comment/admin/batch-remove',
          detailUrl: '/article-comment/admin/one/',
          activeUrl: '/article-comment/admin/active',
          batchActiveUrl: '/article-comment/admin/batch-active'
        },
        page: {
          total: 0
        },
