<template>
  <div>
	...
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始银行卡编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束银行卡编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="持卡人姓名" prop="accountName">
	<Input v-model="searchForm.accountName" placeholder="请输入持卡人姓名"/>
</FormItem>
<FormItem label="银行代码" prop="bankCode">
	<Input v-model="searchForm.bankCode" placeholder="请输入银行代码"/>
</FormItem>
<FormItem label="银行名称" prop="bankName">
	<Input v-model="searchForm.bankName" placeholder="请输入银行名称"/>
</FormItem>
<FormItem label="银行卡号" prop="bankcardNo">
	<Input v-model="searchForm.bankcardNo" placeholder="请输入银行卡号"/>
</FormItem>
