...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>消息编号: <span v-text="form.id"></span></p>
<p>消息标题: <span v-text="form.title"></span></p>
<p>消息摘要: <span v-text="form.summary"></span></p>
<p>消息内容: <span v-text="form.content"></span></p>
<p>消息类型: <span v-text="form.messageType"></span></p>
    ...
    data() {
      return {
        ...
        urls: {
          ...
          allUrl: '/message/admin/all',
          removeUrl: '/message/admin/remove/',
          batchRemoveUrl: '/message/admin/batch-remove',
          detailUrl: '/message/admin/one/',
          activeUrl: '/message/admin/active',
          batchActiveUrl: '/message/admin/batch-active'
        },
        page: {
          total: 0
        },
