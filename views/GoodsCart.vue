...
<FormItem label="购买数量" prop="quantity">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="购物编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始购物编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束购物编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>购物编号: <span v-text="form.id"></span></p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/goods-cart/admin/save',
          batchAddUrl: '/goods-cart/admin/batch-save',
          editUrl: '/goods-cart/admin/update',
          batchEditUrl: '/goods-cart/admin/batch-update',
          searchUrl: '/goods-cart/admin/pager-cond',
          allUrl: '/goods-cart/admin/all',
          removeUrl: '/goods-cart/admin/remove/',
          batchRemoveUrl: '/goods-cart/admin/batch-remove',
          detailUrl: '/goods-cart/admin/one/',
          activeUrl: '/goods-cart/admin/active',
