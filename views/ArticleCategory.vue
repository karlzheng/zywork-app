...
<FormItem label="类别描述" prop="description">
	...
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始类别编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束类别编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="类别名称" prop="title">
	<Input v-model="searchForm.title" placeholder="请输入类别名称"/>
</FormItem>
<FormItem label="类别描述" prop="description">
	<Input v-model="searchForm.description" placeholder="请输入类别描述"/>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>类别编号: <span v-text="form.id"></span></p>
<p>父编号: <span v-text="form.parentId"></span></p>
<p>类别名称: <span v-text="form.title"></span></p>
<p>类别描述: <span v-text="form.description"></span></p>
    ...
    data() {
      return {
        ...
        urls: {
          ...
          searchUrl: '/article-category/admin/pager-cond',
          allUrl: '/article-category/admin/all',
          removeUrl: '/article-category/admin/remove/',
          batchRemoveUrl: '/article-category/admin/batch-remove',
          detailUrl: '/article-category/admin/one/',
          activeUrl: '/article-category/admin/active',
          batchActiveUrl: '/article-category/admin/batch-active'
        },
        page: {
          total: 0
        },
