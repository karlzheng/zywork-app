...
<FormItem label="版本号"><Row>
	...
	<InputNumber v-model="searchForm.goodsOrderLogisticsVersionMin" placeholder="请输入开始版本号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="goodsOrderLogisticsVersionMax">
	<InputNumber v-model="searchForm.goodsOrderLogisticsVersionMax" placeholder="请输入结束版本号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
<FormItem label="创建时间"><Row>
	...
	<DatePicker @on-change="searchForm.goodsOrderLogisticsCreateTimeMin=$event" :value="searchForm.goodsOrderLogisticsCreateTimeMin" placeholder="请输入开始创建时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="goodsOrderLogisticsCreateTimeMax">
	<DatePicker @on-change="searchForm.goodsOrderLogisticsCreateTimeMax=$event" :value="searchForm.goodsOrderLogisticsCreateTimeMax" placeholder="请输入结束创建时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
</i-col>
</Row>
</FormItem>
<FormItem label="更新时间"><Row>
	...
	<DatePicker @on-change="searchForm.goodsOrderLogisticsUpdateTimeMin=$event" :value="searchForm.goodsOrderLogisticsUpdateTimeMin" placeholder="请输入开始更新时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="goodsOrderLogisticsUpdateTimeMax">
	<DatePicker @on-change="searchForm.goodsOrderLogisticsUpdateTimeMax=$event" :value="searchForm.goodsOrderLogisticsUpdateTimeMax" placeholder="请输入结束更新时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<p>物流公司名称: <span v-text="form.goodsOrderLogisticsLogisticsCompany"></span></p>
<p>物流公司编码: <span v-text="form.goodsOrderLogisticsLogisticsCode"></span></p>
<p>物流单号: <span v-text="form.goodsOrderLogisticsLogisticsNo"></span></p>
<p>版本号: <span v-text="form.goodsOrderLogisticsVersion"></span></p>
<p>创建时间: <span v-text="form.goodsOrderLogisticsCreateTime"></span></p>
<p>更新时间: <span v-text="form.goodsOrderLogisticsUpdateTime"></span></p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          searchUrl: '/user-goods-order-logistics/admin/pager-cond',
          allUrl: '/user-goods-order-logistics/admin/all',
          detailUrl: '/user-goods-order-logistics/admin/one/',
          multiUrl: '/user-goods-order-logistics/admin/multi/'
        },
        page: {
          total: 0
        },
...
goodsOrderLogisticsVersion: null,
goodsOrderLogisticsCreateTime: null,
goodsOrderLogisticsUpdateTime: null,
...
goodsOrderLogisticsLogisticsNo: null,
goodsOrderLogisticsVersion: null,
goodsOrderLogisticsVersionMin: null, 
goodsOrderLogisticsVersionMax: null, 
goodsOrderLogisticsCreateTime: null,
goodsOrderLogisticsCreateTimeMin: null, 
goodsOrderLogisticsCreateTimeMax: null, 
goodsOrderLogisticsUpdateTime: null,
goodsOrderLogisticsUpdateTimeMin: null, 
goodsOrderLogisticsUpdateTimeMax: null, 
...
{
title: '物流公司名称',
key: 'goodsOrderLogisticsLogisticsCompany',
minWidth: 120,
sortable: true
},
{
title: '物流公司编码',
key: 'goodsOrderLogisticsLogisticsCode',
minWidth: 120,
sortable: true
},
{
title: '物流单号',
key: 'goodsOrderLogisticsLogisticsNo',
minWidth: 120,
sortable: true
},
{
title: '版本号',
key: 'goodsOrderLogisticsVersion',
minWidth: 120,
sortable: true
},
{
title: '创建时间',
key: 'goodsOrderLogisticsCreateTime',
minWidth: 120,
sortable: true
},
{
title: '更新时间',
key: 'goodsOrderLogisticsUpdateTime',
minWidth: 120,
sortable: true
},
