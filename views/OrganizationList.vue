<template>
  <div>
	...
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始组织编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束组织编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情">
      <p>组织编号: <span v-text="form.id"></span></p>
<p>父编号: <span v-text="form.parentId"></span></p>
<p>组织名称: <span v-text="form.title"></span></p>
<p>组织描述: <span v-text="form.description"></span></p>
    ...
    data() {
      return {
        ...
        urls: {
          ...
          multiUrl: '/organization/admin/multi/'
        },
        page: {
          total: 0
        },
...
sortable: true
    ...
    methods: {
      ...
      fitTable() {
        utils.fitTable(this, 'dataTable', this.table.tableColumns, ['id','parentId','title','description','version','createTime','updateTime','isActive',])
      },
      confirmSelection() {
        // 确认选择的逻辑
      }
