  ...
  <div>
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="路径编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始路径编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束路径编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
<FormItem label="用户路径" prop="userPath">
	<Input v-model="searchForm.userPath" placeholder="请输入用户路径"/>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>路径编号: <span v-text="form.id"></span></p>
<p>用户路径: <span v-text="form.userPath"></span></p>
    ...
    data() {
      return {
        ...
        urls: {
          ...
          searchUrl: '/user-path/admin/pager-cond',
          allUrl: '/user-path/admin/all',
          removeUrl: '/user-path/admin/remove/',
          batchRemoveUrl: '/user-path/admin/batch-remove',
          detailUrl: '/user-path/admin/one/',
          activeUrl: '/user-path/admin/active',
          batchActiveUrl: '/user-path/admin/batch-active'
        },
        page: {
          total: 0
        },
