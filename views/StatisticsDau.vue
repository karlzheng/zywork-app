...
<FormItem label="统计日期" prop="statisticsDate">
	<DatePicker @on-change="form.statisticsDate=$event" :value="form.statisticsDate" placeholder="请输入统计日期" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
...
<FormItem label="统计日期" prop="statisticsDate">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="DAU编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始DAU编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束DAU编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
<FormItem label="DAU"><Row>
	<i-col span="11">
	<FormItem prop="dauMin">
	<InputNumber v-model="searchForm.dauMin" placeholder="请输入开始DAU" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="dauMax">
	<InputNumber v-model="searchForm.dauMax" placeholder="请输入结束DAU" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
    ...
    data() {
      return {
        ...
        urls: {
          ...
          searchUrl: '/statistics-dau/admin/pager-cond',
          allUrl: '/statistics-dau/admin/all',
          removeUrl: '/statistics-dau/admin/remove/',
          batchRemoveUrl: '/statistics-dau/admin/batch-remove',
          detailUrl: '/statistics-dau/admin/one/',
          activeUrl: '/statistics-dau/admin/active',
          batchActiveUrl: '/statistics-dau/admin/batch-active'
        },
        page: {
          total: 0
        },
