<template>
  <div>
	...
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始模块编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束模块编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情">
      <p>模块编号: <span v-text="form.id"></span></p>
<p>模块标题: <span v-text="form.title"></span></p>
<p>模块描述: <span v-text="form.description"></span></p>
...
sortable: true
    ...
    methods: {
      ...
      fitTable() {
        utils.fitTable(this, 'dataTable', this.table.tableColumns, ['id','title','description','version','createTime','updateTime','isActive',])
      },
      confirmSelection() {
        // 确认选择的逻辑
      }
